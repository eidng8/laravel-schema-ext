...
class PostgresTest extends TestCase
{
  public function test_binary_column()
  {
    ...
    $this->assertSql(
      ['alter table "test_table" add column "test_column" bytea(255) not null'],
      $blueprint
    );
  }
  ...
  public function test_binary_column_with_length()
  {
    ...
    $this->assertSql(
      ['alter table "test_table" add column "test_column" bytea(16) not null'],
      $blueprint
    );
  }
  ...
  public function test_uuid_foreign_for_model()
  {
    ...
    $this->assertSql(
      [
        'alter table "test_table" add column "test_id" bytea(16) not null',
  ...
  public function test_id_foreign_for_model()
  {
    ...
    $this->assertSql(
      [
        'alter table "test_table" add column "test_id" bigint not null',
        'alter table "test_table" add constraint "test_table_test_id_foreign" foreign key ("test_id") references "tests" ("id")',
      ],
      $blueprint
    );
